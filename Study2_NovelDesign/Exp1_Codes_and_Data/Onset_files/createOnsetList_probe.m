...
%% Define Variables
task_name = 'probe';
trial_duration = 2; % duration of non ISI trial: training = 1; probe = 2;
mean_t = 3; % the mean requested ISI jitter (not including the trial duration)
...
numTrials = 64; % number trials: training = 40/60/80
